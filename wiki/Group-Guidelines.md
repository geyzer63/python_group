...
1.  Use https://ppaste.org for your code, copy + paste, then post the link generated into your post.  
...
05. **Posts seeking help about code debugging** include the following:   
     ...
     **Options for sharing your code in a post:**      
         ...
         2). Use a code pastebin service/website like, https://ppaste.org, http://dpaste.de/ , https://gist.github.com/, etc. Not knowing how to use a paste bin service, is no excuse. Usage is basic, copy + paste, like the name implies. Detailed steps are linked here => [How to Use a Pastebin](https://github.com/pythonprogramming-group/python_group/wiki/How-To-Use-Pastebin); or  
